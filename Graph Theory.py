...
print ("The largest clique for 6: ", cliqueSet (3))
for i in range (0, n (G)):
...
print ("The ind. number is: ", len (indSet ()))
...
#I think that this funtion works a lot better than the other clique function
#that I had
def findcliq (v):
    cliq = {v}
    tempSet = {v}
    ...
    #        if (y in N(x, G)):
     #           cliq = set.union (cliq, {x})
      #          print (1)
       #         print (cliq)
    #return cliq

print ("The other clique function: ")
for i in range (0, n (G)):
    print ("Clique for ", i, ": ", findcliq (i))
...
def isDom (Set):
    ...
    for x in Set:
        print (x)
        for y in set.difference(vertexSet (), Set):
            print (y)
            if x not in N (y, G) and x != y:
                isDom = False
                print ("uh oh!")
    return isDom
